...
public class ProductRepositoryTests {
	...
	public void testCreateProduct() {
		Product savedProduct = repo.save(new Product("iPhone 16", 789));
	...
	public void testFindProductByName() {
		Product product = repo.findByName("iPhone 16");
	...
	public void testUpdateProduct() {
		...
		repo.save(product);
		Product updatedProduct = repo.findByName("iPhone 16");
	...
	public void testDeleteProduct() {
		...
		Product deletedProduct = repo.findByName("iPhone 16");
